...
function reducer(state = initialState, action) {
  switch (action.type) {
    case "SET_INTERACTING_CONVERSATION":
      return {
        ...state,
        interactingConvo: action.payload,
      };
    ...
    case "U_LOADING":
      return {
        ...state,
        uLoading: action.payload,
      };
    case "U_LOADED":
      return {
        ...state,
        uLoaded: action.payload,
      };
    case "SET_USER":
      return {
        ...state,
    ...
    case "SEND_MESSAGE_LOADED":
      return {
        ...state,
        sendMessageLoaded: action.payload,
      };
    ...
    case "SET_INTERACTING_USER":
      return {
        ...state,
        interactingUser: action.payload,
      };
    case "SET_ONE_USER":
      return {
        ...state,
